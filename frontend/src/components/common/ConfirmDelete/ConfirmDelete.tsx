...
export default function ConfirmDelete({ onConfirm, onCancel, loading, error }: ConfirmDeleteProps) {
  return (
    <Modal onClose={onCancel} className="w-80 text-center" showClose={false}>
      ...
      <p className="mb-6 text-gray-700 font-medium">Yakin ingin menghapus vocab ini?</p>
